...
void MainWindow::onKeyClicked(){
    ...
    this->ui->skipButton->setDisabled(true);
    this->ui->nextButton->setDisabled(false);
    this->ui->keyButton->setDisabled(true);
...
void MainWindow::onNextClicked(){
    ...
    if(this->isKeyShown){
        ...
        if(!this->in->atEnd()){
            ...
            qDebug() << "End not yet reached";
            this->isKeyShown=false;
            this->skipCount=0;
            if(this->ui->nextButton->isEnabled()){
                this->ui->nextButton->setDisabled(true);
            }
            this->ui->skipButton->setDisabled(false);
            this->ui->keyButton->setDisabled(false);
            this->setText();
...
void MainWindow::on_initButton_clicked()
{
    ...
    qDebug() << "file Name:" << this->fileName;
